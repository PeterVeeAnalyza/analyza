<?php
// source: /var/www/clients/client0/web1/web/analyza/app/config/config.neon 

class Container_a2828197fd extends Nette\DI\Container
{
	...
	protected $meta = array(
		'types' => array(
			'Nette\Object' => array(
				array(
					...
					'64_App_Forms_SignFormFactory',
					'65_App_Model_UserManager',
					'application.1',
					'application.2',
					'application.3',
					'application.4',
			...
			'App\Forms\SignFormFactory' => array(
				1 => array('64_App_Forms_SignFormFactory'),
			),
			'Nette\Security\IAuthenticator' => array(1 => array('65_App_Model_UserManager')),
			'App\Model\UserManager' => array(1 => array('65_App_Model_UserManager')),
		...
		'services' => array(
			'64_App_Forms_SignFormFactory' => 'App\Forms\SignFormFactory',
			'65_App_Model_UserManager' => 'App\Model\UserManager',
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/var/www/clients/client0/web1/web/analyza/app',
			'wwwDir' => '/var/www/clients/client0/web1/web/analyza/www',
			'debugMode' => TRUE,
			'productionMode' => FALSE,
			'environment' => 'development',
			'consoleMode' => FALSE,
			'container' => array('class' => NULL, 'parent' => NULL),
			'tempDir' => '/var/www/clients/client0/web1/web/analyza/app/../temp',
	 ...
	 */
	public function createService__64_App_Forms_SignFormFactory()
	{
	 ...
	 */
	public function createService__65_App_Model_UserManager()
	{
		$service = new App\Model\UserManager($this->getService('doctrine.default.entityManager'));
		return $service;
	}
	...
	public function createServiceAnnotations__cache__annotations()
	{
		...
		$service->setNamespace('Kdyby_annotations.cache.annotations_a9b42083');
		return $service;
	}
	...
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback($this, 5, '/var/www/clients/client0/web1/web/analyza/app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'));
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/var/www/clients/client0/web1/web/analyza/app/../temp');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/var/www/clients/client0/web1/web/analyza/app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__dbalResult()
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.dbalResult_a9b42083');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__hydration()
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.hydration_a9b42083');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__metadata()
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.metadata_a9b42083');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__ormResult()
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.ormResult_a9b42083');
		return $service;
	}
	...
	public function createServiceDoctrine__cache__default__query()
	{
		...
		$service->setNamespace('Kdyby_doctrine.cache.default.query_a9b42083');
		return $service;
	}
	...
	{
		return new Container_a2828197fd_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory($this);
	}
	...
	public function createServiceDoctrine__default__driver__App__annotationsImpl()
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(array(
			'/var/www/clients/client0/web1/web/analyza/app',
	...
	{
		$service = new Kdyby\Doctrine\Mapping\AnnotationDriver(array(
			'/var/www/clients/client0/web1/web/analyza/vendor/kdyby/doctrine/src/Kdyby/Doctrine/DI/../Entities',
		), $this->getService('annotations.reader'), $this->getService('doctrine.cache.default.metadata'));
		return $service;
	}
	...
	public function createServiceDoctrine__default__ormConfiguration()
	{
		...
		$service->setProxyDir('/var/www/clients/client0/web1/web/analyza/app/../temp/proxies');
	...
	{
		$service = new Kdyby\Doctrine\Proxy\ProxyAutoloader('/var/www/clients/client0/web1/web/analyza/app/../temp/proxies',
	...
	{
		return new Container_a2828197fd_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory($this);
	}
	...
	public function createServiceNette__latte()
	{
		...
		trigger_error('Service nette.latte is deprecated, implement Nette\Bridges\ApplicationLatte\ILatteFactory.',
			16384);
		$service->setTempDirectory('/var/www/clients/client0/web1/web/analyza/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Security\User($this->getService('security.userStorage'), $this->getService('65_App_Model_UserManager'));
	...
	public function initialize()
	{
		...
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/var/www/clients/client0/web1/web/analyza/vendor/kdyby/doctrine/src/Kdyby/Doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/var/www/clients/client0/web1/web/analyza/vendor/doctrine';
		Tracy\Debugger::getBlueScreen()->collapsePaths[] = '/var/www/clients/client0/web1/web/analyza/app/../temp/proxies';
	}
...
final class Container_a2828197fd_Kdyby_Doctrine_EntityDaoFactoryImpl_doctrine_daoFactory implements Kdyby\Doctrine\EntityDaoFactory
{

	private $container;


	public function __construct(Container_a2828197fd $container)
	{
...
final class Container_a2828197fd_Nette_Bridges_ApplicationLatte_ILatteFactoryImpl_latte_latteFactory implements Nette\Bridges\ApplicationLatte\ILatteFactory
{
