<?php
// source: /var/www/clients/client0/web1/web/analyza/app/presenters/templates/@layout.latte

class Template8f172a15e4342459cfe1c9e4f92061be extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('3b2da89dec', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbd2d8b71464_head')) { function _lbd2d8b71464_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb6955c44acb_scripts')) { function _lb6955c44acb_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
