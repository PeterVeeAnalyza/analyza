<?php
// source: /var/www/analyza/analyza/app/presenters/templates/@layout.latte

class Template9bc90906ee55bffde79daf9dec8e19ff extends Latte\Template {
function render() {
foreach ($this->params as $__k => $__v) $$__k = $__v; unset($__k, $__v);
// prolog Latte\Macros\CoreMacros
list($_b, $_g, $_l) = $template->initialize('f62ef41e60', 'html')
;
// prolog Latte\Macros\BlockMacros
//
// block head
//
if (!function_exists($_b->blocks['head'][] = '_lbff42108d9b_head')) { function _lbff42108d9b_head($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
;
}}
...
// block scripts
//
if (!function_exists($_b->blocks['scripts'][] = '_lb4d567e894f_scripts')) { function _lb4d567e894f_scripts($_b, $_args) { foreach ($_args as $__k => $__v) $$__k = $__v
